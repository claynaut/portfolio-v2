...
import { ProjectBlurb } from '@/components/Project'
...
export default function Projects() {
  ...
  const upcoming = [
    ...
    {
      link: '/projects',
      title: 'A Platform for Artists',
      date: 'TBD',
      caption: 'Attempting to create a platform that prioritizes the community in order to bring artists of all kinds together.',
      stack: [
        'TBD',
      ],
      external: false,
  ...
  const completed = [
    ...
    {
      link: 'https://lotushacks2022-dev.vercel.app/',
